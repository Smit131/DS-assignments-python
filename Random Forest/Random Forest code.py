...
df = pd.read_csv("G:\\Data Science\\Assn 14 - Random Forest\\Python code\\Fraud_check.csv")
df.info()
df.isnull().sum()
# no null
...
m1 = RandomForestClassifier(n_jobs = 3, oob_score=True,n_estimators=20,criterion="entropy")
m1.fit(tr_x,tr_y)
m1.oob_score_
m1.estimators_ # gives something lol....info on each decision tree prepaired by it 
